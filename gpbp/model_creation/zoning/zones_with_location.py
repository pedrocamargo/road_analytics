...
def zones_with_location(hexb, all_subdivisions):
    ...
    zones_with_location = gpd.GeoDataFrame(data_complete[['hex_id', 'division_name_x', 'x', 'y']], 
                                           geometry=data_complete['geometry']).rename(columns={'division_name_x':'division_name'})
