...
from functions.rai.meta_population_data import meta_population_data
from functions.load_zones import load_zones
from geopandas import sjoin_nearest

def meta_RAI_data(project, country_name):
    
    print('Obtaining population data')
    pop_data = meta_population_data(country_name, project).to_crs(3857)
