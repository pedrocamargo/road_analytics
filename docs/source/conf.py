...
latex_documents = [
    (master_doc, "RoadAnalytics.tex", "RoadAnalytics Documentation", "Pedro Camargo", "manual")]

pdf_documents = [
    (master_doc, u"RoadAnalytics.pdf", u"RoadAnalytics Documentation", u"Pedro Camargo")]
